...
Οι εκπαιδευτικοί στόχοι του έργου είναι τα παιδιά να  
...
Στα παιδιά των συνεργαζόμενων σχολείων  επεξεργασία της ιστορίας, πρόκειται να τεθεί ένα βασικό ερώτημα, “ ‘’Πώς θα μπορούσε να είναι η αυλή του σχολείου μας να μετατραπεί σε ένα χώρο δημιουργικού παιχνιδιού και περιπέτειας;"Ενώ παράλληλα λαμβάνονται υπόψη και άλλα ερωτήματα όπως:
...
Aν έχετε την δυνατότητα να την σχεδιάσετε εξ αρχής σταθμούς παιχνιδιών πώς θα ήταν;
...
Σε αυτό το σημείο κάθε σχολείο αναλαμβάνει να ερευνήσει τα στοιχεία που πρέπει να περιλαμβάνει η αυλή του σχολείου που ανέλαβε, όπως προέκυψαν από την προηγούμενη φάση, ώστε να είναι ένας χώρος που θα εμπνέει το παιχνίδι και τη δημιουργικότητα. Στο πλαίσιο της ολομέλειας τα παιδιά, με διευκολυντικές ερωτήσεις που γίνονται από τις εκπαιδευτικούς συζητούν σχετικά με το σχεδιασμό των παιχνιδιών στο χώρο της αυλής ώστε να γίνει πιο λειτουργική αναφορικά με τις προτάσεις για τους σταθμούς παιχνιδιών , και γίνονται οι απαραίτητες καταγραφές. 
Τα παιδιά εμπλέκονται ενεργά στο σχεδιασμό των παιχνιδιών, ως προς το το περιεχόμενο και την επιλογή των υλικών που θα αξιοποιήσουν ώστε να υλοποιηθούν οι ιδέες τους. Θα χωριστούν σε ανομοιογενείς ομάδες, όπου θα αναλάβουν ρόλους,  θα συνεργαστούν, θα διερευνήσουν, ασκώντας κριτική και εκφράζοντας απόψεις σε ποικίλα  προβλήματα προς επίλυση, που μπορεί να αντιμετωπίσουν για την υλοποίηση της δημιουργικής αυλής, αξιοποιώντας πάντα τα προσωπικά τους βιώματα και εμπειρίες και με αυτό τον τρόπο θα λάβουν αποφάσεις. 

3η φάση – Στοχασμός-Ανατροφοδότηση-Αναθεώρηση

Σε αυτή τη φάση θα έχει ολοκληρωθεί η κατασκευή των παιχνιδιών στους σταθμούς που θα έχουν δημιουργηθεί στην αυλή, αξιοποιώντας την προστιθέμενη αξία εφαρμογών της τεχνητής νοημοσύνης (ChatGPT, DALL-E, Beatoven.ai κτλ.), των qr codes, την αξιοποίηση φορητών συσκευών (tablet και laptop) αξιοποιώντας το πλαίσιο της φορητής μάθησης αλλά και τεχνολογικών εργαλείων όπως το κιτ εφευρέσεων Makey Makey και  κιτ ρομποτικής όπως bee bot/bluebot, (εξοπλισμό που διαθέτουν τα σχολεία από τη συμμετοχή τους σε διαγωνισμούς της ΕΛΛΑΚ, παλαιότερων ετών). Στη συνέχεια θα δοθεί στα παιδιά η δυνατότητα να παρατηρήσουν και να σταθούν κριτικά απέναντι στις δημιουργίες τους. Θα έχουν την ευκαιρία να συζητήσουν με τους/τις συμμαθητές/τριες τους και να κάνουν εκ νέου προτάσεις με σκοπό τον ανασχεδιασμό και την τροποποίηση των παιχνιδιών, αν παρατηρήσουν ότι κάτι δεν είναι λειτουργικό ή πρέπει να αλλάξει.
...
κιτ εφευρέσεων makey makey (θα αξιοποιηθεί ο εξοπλισμός από το έργο της προηγούμενης χρονιάς)

επιδαπέδια ρομπότ blue bot και bee bot
